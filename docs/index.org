...
*** TODO Create language tour doc and link here
For more information, see [[./tour/][A tour of the Chakra language]]
...
For more information, see [[./types/][Chakra's Type System]]
...
For more information see [[./message-passing/][Message Passing in Chakra]]

** Fast, simple concurrency
*** DONE Complete this section
    CLOSED: [2019-03-31 Sun 08:59]
...
*** TODO Create doc about Actors in Chakra and link here
For more information, see [[./actors/][Actors and Concurrency in Chakra]]
